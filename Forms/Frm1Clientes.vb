...
Public Class Frm1Clientes
    Dim cli As New Clientes
    Dim conex As New Conexion

    Private Sub Frm1Clientes_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub Modificar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Modificar.Click
        ...
        Dim FrmClientes As New FrmClientes(cli)
        FrmClientes.showdialog()
        cli.LlenarTabla(DataGridView1)
